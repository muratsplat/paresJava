...
public class ParserTest {
    ...
    {
        Parser pares = new Parser(ParserTest.PARES_EXAMPLE);
        Model m = pares.Parse();

        assertEquals(m.getTXECI(), "02");
        assertEquals(
                "MDAwMDAwMDAwMDEyMzQ1Njc4OTA=",
                m.getXID()

        );

        assertEquals(
                "jI3JBkkaQ1p8CBAAABy0CHUAAAA=",
                m.getTXCAVV()
        );
    }
